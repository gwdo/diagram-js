...
import { unionBy } from 'min-dash/lib/collection';
...
export default class CommandStack {
  ...
  _popAction() {
    ...
    if (!actions.length) {
      this._eventBus.fire('elements.changed', { elements: uniqueElements(...dirty) });
