...
import svgTransform from 'tiny-svg/lib/transform';

import { createMatrix } from 'tiny-svg/lib/geometry';
...
export default class Canvas {
  ...
  _init(config) {
    ...
    if (config.deferUpdate !== false) {
      this._viewboxChanged = debounce(this._viewboxChanged.bind(this), 300);
    }
   ...
   */
  _addElement(type, element, parent, parentIndex) {
