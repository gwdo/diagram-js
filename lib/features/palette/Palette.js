...
Palette.prototype._init = function () {
    ...
    var parent = domQuery('#bpmn-palette'),
...
Palette.prototype._update = function () {
    ...
    forEach(entries, function (entry, id) {
        var grouping = entry.group && entry.group.group || 'default';
        var container = domQuery('[data-group=' + grouping + ']', entriesContainer);
        if (!container) {
            container = domify('<div class="group" data-group="' + grouping + '"><div class="group-title" data-group-title>' + grouping + '</div><div class="group-nodes"></div></div>');
        ...
        var nodes = domQuery('[data-group=' + grouping + '] .group-nodes', entriesContainer);
        var control = domify(html);
        nodes.appendChild(control);
    ...
    let groups = domQuery.all('.group');

    forEach(groups, function (group) {
        const element = '.group-title';
        domDelegate.bind(group, element, 'click', function (event) {
            const el = domQuery('.group-nodes', group);
...
Palette.prototype.updateToolHighlight = function (name) {
    ...
    console.log(toolsContainer.children, name);
