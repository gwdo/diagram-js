...
import { Event as InternalEvent } from '../../core/EventBus';
...
const DRAG_ACTIVE_CLS = 'djs-drag-active';
...
export default class Dragging {
  ...
  constructor(eventBus, canvas, selection) {
    ...
    function fire(type, dragContext) {
      ...
      var event = assign(new InternalEvent(), dragContext.payload, dragContext.data);
    ...
    function move(event, activate) {
      ...
      var globalStart = context.globalStart,
          ...
          globalDelta = substractPoints(globalCurrent, globalStart);

      var localStart = context.localStart,
          localCurrent = toLocalPoint(globalCurrent),
          localDelta = substractPoints(localCurrent, localStart);
    ...
    function init(event, relativeTo, prefix, options) {
      ...
      if (event) {
        originalEvent = getOriginalEvent(event) || event;
      ...
      context = assign({
        ...
        displacement: substractPoints(relativeTo, localStart),
