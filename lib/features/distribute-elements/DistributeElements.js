...
export default class DistributeElements {
  ...
  _createGroups(elements) {
    ...
    var sortedElements = sortBy(elements, (e) => e[axis]);

    forEach(sortedElements, (element, idx) => {
   ...
   * @return {Boolean}
   */
  _hasIntersection(rangeA, rangeB) {
