...
import {
  getClosure as getElementsClosure
} from '../../../../util/Elements';
...
export default class MoveHelper {
   ...
   */
  moveRecursive(elements, delta, newParent) {
    if (!elements) {
      return [];
    } else {
   ...
   */
  moveClosure(closure, delta, newParent, newHost, primaryShape) {
   ...
   */
  getClosure(elements) {
    return getElementsClosure(elements);
  }
}