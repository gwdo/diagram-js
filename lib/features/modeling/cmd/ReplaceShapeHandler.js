 ...
 * @param {canvas} Canvas
 */
class ReplaceShapeHandler {
  constructor(modeling, rules) {
  ...
  createShape(shape, position, target) {
    var modeling = this._modeling;
    return modeling.createShape(shape, position, target);
  }

  reconnectStart(connection, newSource, dockingPoint) {
    var modeling = this._modeling;
    modeling.reconnectStart(connection, newSource, dockingPoint);
  }

  reconnectEnd(connection, newTarget, dockingPoint) {
    var modeling = this._modeling;
